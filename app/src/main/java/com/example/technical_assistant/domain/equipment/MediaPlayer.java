...
public class MediaPlayer extends Equipment {
    public MediaPlayer() {
    }

    public MediaPlayer(String name, String model, String manufacturer, String serialNumber, String macAddress, String macAddress1, String macAddress2,
