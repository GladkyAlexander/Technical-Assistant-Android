...
public class VideoTransmitter extends Equipment {
    public VideoTransmitter() {
    }

    public VideoTransmitter(String name, String model, String manufacturer, String serialNumber, String macAddress, String macAddress1, String macAddress2,
